		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDcsProductV1DataSourceID("data.telefonicaopencloud_dcs_product_v1.product1"),
					resource.TestCheckResourceAttr(
						"data.telefonicaopencloud_dcs_product_v1.product1", "spec_code", "dcs.single_node"),
				),
			},
		},
	})
