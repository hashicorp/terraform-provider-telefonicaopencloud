		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckAntiDdosV1Exists("telefonicaopencloud_antiddos_v1.antiddos_1", &antiddos),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "enable_l7", "true"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "traffic_pos_id", "1"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "http_request_pos_id", "2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "cleaning_access_pos_id", "1"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "app_type_id", "0"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "traffic_pos_id", "2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "http_request_pos_id", "1"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "cleaning_access_pos_id", "2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_antiddos_v1.antiddos_1", "app_type_id", "1"),
				),
			},
		},
	})
...
func testAccCheckAntiDdosV1Destroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "telefonicaopencloud_antiddos_v1" {
			continue
		}
...
resource "telefonicaopencloud_antiddos_v1" "antiddos_1" {
  floating_ip_id = "${telefonicaopencloud_vpc_eip_v1.eip_1.id}"
  enable_l7 = true
  traffic_pos_id = 1
