		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2BmsInstanceExists("telefonicaopencloud_compute_bms_server_v2.instance_1", &instance),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_compute_bms_server_v2.instance_1", "availability_zone", OS_AVAILABILITY_ZONE),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2BmsInstanceExists("telefonicaopencloud_compute_bms_server_v2.instance_1", &instance),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_compute_bms_server_v2.instance_1", "name", "instance_2"),
				),
			},
		},
	})
...
func testAccCheckComputeV2BmsInstanceDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "telefonicaopencloud_compute_bms_server_v2" {
			continue
		}
...
resource "telefonicaopencloud_compute_bms_server_v2" "instance_1" {
  name = "instance_1"
