		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCSBSBackupPolicyV1DataSourceID("data.telefonicaopencloud_csbs_backup_policy_v1.csbs_policy"),
					resource.TestCheckResourceAttr("data.telefonicaopencloud_csbs_backup_policy_v1.csbs_policy", "name", "backup-policy"),
					resource.TestCheckResourceAttr("data.telefonicaopencloud_csbs_backup_policy_v1.csbs_policy", "status", "suspended"),
				),
			},
		},
	})
...
data "telefonicaopencloud_csbs_backup_policy_v1" "csbs_policy" {  
  id = "${telefonicaopencloud_csbs_backup_policy_v1.backup_policy_v1.id}"
}
