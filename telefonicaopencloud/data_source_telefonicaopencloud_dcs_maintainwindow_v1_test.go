		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckDcsMaintainWindowV1DataSourceID("data.telefonicaopencloud_dcs_maintainwindow_v1.maintainwindow1"),
					resource.TestCheckResourceAttr(
						"data.telefonicaopencloud_dcs_maintainwindow_v1.maintainwindow1", "seq", "1"),
					resource.TestCheckResourceAttr(
						"data.telefonicaopencloud_dcs_maintainwindow_v1.maintainwindow1", "begin", "22"),
				),
			},
		},
	})
