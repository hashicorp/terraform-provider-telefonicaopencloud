		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCSBSBackupV1DataSourceID("data.telefonicaopencloud_csbs_backup_v1.csbs"),
					resource.TestCheckResourceAttr("data.telefonicaopencloud_csbs_backup_v1.csbs", "backup_name", "csbs-test"),
					resource.TestCheckResourceAttr("data.telefonicaopencloud_csbs_backup_v1.csbs", "resource_name", "instance_1"),
				),
			},
		},
	})
...
resource "telefonicaopencloud_csbs_backup_v1" "csbs" {
  backup_name      = "csbs-test"
  description      = "test-code"
  resource_id = "${telefonicaopencloud_compute_instance_v2.instance_1.id}"
  resource_type = "OS::Nova::Server"
}
data "telefonicaopencloud_csbs_backup_v1" "csbs" {
  id = "${telefonicaopencloud_csbs_backup_v1.csbs.id}"
}
