		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSFSFileSystemV2Exists("telefonicaopencloud_sfs_file_system_v2.sfs_1", &share),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "name", "sfs-test1"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "share_proto", "NFS"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "status", "available"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "size", "1"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "access_level", "rw"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "access_to", OS_VPC_ID),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "access_type", "cert"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckSFSFileSystemV2Exists("telefonicaopencloud_sfs_file_system_v2.sfs_1", &share),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "name", "sfs-test2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "share_proto", "NFS"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "status", "available"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "size", "2"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "access_level", "rw"),
					resource.TestCheckResourceAttr(
						"telefonicaopencloud_sfs_file_system_v2.sfs_1", "access_to", OS_VPC_ID),
...
func testAccCheckSFSFileSystemV2Destroy(s *terraform.State) error {
	...
	if err != nil {
		return fmt.Errorf("Error creating Telefonicaopencloud sfs client: %s", err)
	}

	for _, rs := range s.RootModule().Resources {
		if rs.Type != "telefonicaopencloud_sfs_file_system_v2" {
			continue
		}
