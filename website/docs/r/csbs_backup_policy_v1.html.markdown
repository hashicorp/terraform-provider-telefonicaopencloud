...
page_title: "TelefonicaOpenCloud: resource_telefonicaopencloud_csbs_backup_policy_v1"
sidebar_current: "docs-telefonicaopencloud-resource-csbs-backup-policy-v1"
description: |-
  Provides an TelefonicaOpenCloud Backup Policy of Resource.
---
...
```
$ terraform import telefonicaopencloud_csbs_backup_policy_v1.backup_policy_v1 7056d636-ac60-4663-8a6c-82d3c32c1c64
```
