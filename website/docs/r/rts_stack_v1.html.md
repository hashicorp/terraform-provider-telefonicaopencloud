...
page_title: "TelefonicaOpenCloud: resource_telefonicaopencloud_rts_stack_v1"
sidebar_current: "docs-telefonicaopencloud-resource-rts-stack-v1"
description: |-
  Provides an TelefonicaOpenCloud RTS Stack.
---
...
```
$ terraform import telefonicaopencloud_rts_stack_v1.mystack rts-stack
```
...
`telefonicaopencloud_rts_stack_v1` provides the following
