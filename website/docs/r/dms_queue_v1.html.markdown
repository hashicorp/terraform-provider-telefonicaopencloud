...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_dms_queue_v1"
sidebar_current: "docs-telefonicaopencloud-resource-dms-queue-v2"
description: |-
  Manages a DMS queue in the TelefonicaOpenCloud DMS Service
---

# telefonicaopencloud\_dms\_queue_v2
