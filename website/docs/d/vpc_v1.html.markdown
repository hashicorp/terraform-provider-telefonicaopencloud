...
sidebar_current: "docs-telefonicaopencloud-datasource-vpc-v1"
description: |-
  Get information on an TelefonicaOpenCloud VPC.
---

# Data Source: telefonicaopencloud_vpc_v1

telefonicaopencloud_vpc_v1 provides details about a specific VPC.
