...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_csbs_backup_policy_v1"
sidebar_current: "docs-telefonicaopencloud-datasource-csbs-backup-policy-v1"
description: |-
  Provides details about a specific Backup Policy.
---

# Data Source: telefonicaopencloud_csbs_backup_policy_v1

The TelefonicaOpenCloud CSBS Backup Policy data source allows access of backup Policy resources.
