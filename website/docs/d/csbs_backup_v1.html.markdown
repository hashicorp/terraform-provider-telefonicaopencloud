...
page_title: "TelefonicaOpenCloud: telefonicaopencloud_csbs_backup_v1"
sidebar_current: "docs-telefonicaopencloud-datasource-csbs-backup-v1"
description: |-
  Provides details about a specific Backup.
---

# Data Source: telefonicaopencloud_csbs_backup_v1

The TelefonicaOpenCloud CSBS Backup data source allows access of backup resources.
